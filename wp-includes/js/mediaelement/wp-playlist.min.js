! function(a, b, c) {
    ...
    var e = c.View.extend({
        ...
        loadCurrent: function() {
            ...
            this.mejs && this.mejs.pause(), a !== b ? this.setPlayer(!0) : (this.playerNode.attr("src", this.current.get("src")), this.playCurrentSrc())
        },
        setCurrent: function() {
    ...
    window.wp.playlist = {
        initialize: d
    }, a(document).ready(d), window.WPPlaylistView = e
}(jQuery, _, Backbone);