                ...
                $('.svg-icon-holder:not(.animated-in)').each(function(i) {
                    ...
                    function checkIfReady() {
                        ...
                        if ($svg_icons[$that.attr('id').slice(-1)].isReady == true) {
                            $that.css('opacity', '1');
                            setTimeout(function() {
                                $svg_icons[$that.attr('id').slice(-1)].reset().play();
                            }, $animationDelay);
                        } else {
        ...
        if ($('#slide-out-widget-area.slide-out-from-right-hover').length > 0) {
            ...
            function calculateHoverNavMinHeight() {
                ...
                $('#slide-out-widget-area.slide-out-from-right-hover > .inner .off-canvas-menu-container').transition({
                    y: '-' + ($('#slide-out-widget-area.slide-out-from-right-hover > .inner .off-canvas-menu-container').height() / 2) + 'px'
                }, 0);
                ...
                if ($('header#top .container .span_9 > .slide-out-widget-area-toggle').length > 0) {
                    ...
                    if ($('body.mobile').length > 0) {
                        ...
                        $('.slide-out-hover-icon-effect').css({
                            'top': adminBarHeight + $('header#top .span_9 > .slide-out-widget-area-toggle').position().top + parseInt($('#header-outer').css('padding-top')) - 5,
                        ...
                        if ($('body.ascend').length > 0) {
                            ...
                            $('.slide-out-hover-icon-effect').css({
                                'top': adminBarHeight + parseInt($('header#top nav >ul .slide-out-widget-area-toggle a').css('padding-top')),
                                'right': parseInt($('#header-outer header >.container').css('padding-right')) + $extraCushion
                            });
                        } else {
                            $('.slide-out-hover-icon-effect').css({
                                'top': adminBarHeight + parseInt($('header#top nav >ul .slide-out-widget-area-toggle').css('padding-top')) + parseInt($('#header-outer').css('padding-top')),
