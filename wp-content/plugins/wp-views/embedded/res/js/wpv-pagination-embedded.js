...
WPViews.ViewPagination = function($) {
    ...
    */
        ...
        self.pagination_effects = {
                ...
                if (slide_data.next === true) {
                    ...
                    if (old_height === new_height) {
                        slide_data.wpvPaginatorLayout
                            .parent()
                            .animate({
                                marginLeft: '-' + slide_data.wpvPaginatorLayout.outerWidth() + 'px'
                            }, slide_data.speed + 500, function() {
                                slide_data.responseView.css({
                                    'position': 'static',
                                    'float': 'none'
                                });
            ...
            slidev: function(slide_data) {
                ...
                if (slide_data.next === true) {
                    ...
                    new_height = slide_data.responseView.outerHeight();
                    slide_data.wpvPaginatorLayout.parent().css({
                        'position': 'relative',
    ...
    self.init_paged_views = function(container) {
        ...
        if (!self.init_scrolling_event_fired &&
        ...
        if (
            ...
            setTimeout(function() {
                ...
                if (self.rollover_paused[rollover_index] &&
                    ...
                    if (!wpv_stop_rollover.hasOwnProperty(view_number) &&
                        $("#wpv-view-layout-" + view_number).length > 0
                    ) {
